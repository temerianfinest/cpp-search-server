...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus state=DocumentStatus::ACTUAL) 
     const {
...
private:
    ...
    template<typename Function>
    vector<Document> FindAllDocuments(const Query& query, Function function) 
   const {
